    ...
    <div class="flex w-full flex-col gap-4">
      ...
      <div class="flex min-h-24 w-full items-center justify-center">
        <Transition name="fade">
          ...
          <InstructionsBlock v-show="hasSolution && !isLoading" :current_moves="rubikCurrentFrame" :nb_moves="rubikResult ? rubikResult.nb_moves : 0" :description="rubikResult && rubikResult.result && rubikResult.result[rubikCurrentFrame] ? rubikResult.result[rubikCurrentFrame].description : ''" @display-modal="toggleSolutionModal" />
